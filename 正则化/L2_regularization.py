# -*- coding:utf-8 -*-
"""
weight decay对比实验，通过可视化我们发现，经过L2正则以后，所有的参数明显更加集中在0附近了
"""
import torch
...
# ============================ step 1/5 数据 ============================
def gen_data(num_data=10, x_range=(-1, 1)): # 生成分布在直线周围的散点作为数据
...
# ============================ step 2/5 模型 ============================
class MLP(nn.Module): # 使用一个简单的多层感知机
...
# ============================ step 3/5 优化器 ============================
# 我们使用两个不同的优化器，一个没有weight_decay，一个有，对比它们对参数取值范围的影响
