# -*- coding:utf-8 -*-
"""
dropout在自己生成的数据上做实验，发现有dropout的模型拟合的曲线更加平滑，不会过拟合
"""
import torch
...
# ============================ step 1/5 数据 ============================
def gen_data(num_data=10, x_range=(-1, 1)): # 生成有随机扰动的直线
...
net_prob_0 = MLP(neural_num=n_hidden, d_prob=0.) # 无dropout
net_prob_05 = MLP(neural_num=n_hidden, d_prob=0.5) # 有dropout
